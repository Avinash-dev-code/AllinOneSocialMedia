            ...
            imgIcon.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    switch (getAdapterPosition()){
                        case 0:
                            Intent intent=new Intent(v.getContext(),ForFacebook.class);
                            v.getContext().startActivity(intent);


                            break;
                        case 1:
                            Intent intent1=new Intent(v.getContext(),ForInstagram.class);
                            v.getContext().startActivity(intent1);
                            break;

                        case 2:
                            Intent intent2=new Intent(v.getContext(),Snapchat.class);
                            v.getContext().startActivity(intent2);

                            break;
                        case 3:
                            Intent intent3=new Intent(v.getContext(),Linkedin.class);
                        ...
                        case 5:
                            Intent intent5=new Intent(v.getContext(),ForSpotify.class);
                            v.getContext().startActivity(intent5);

                            break;
                        case 6:
                            Intent intent6=new Intent(v.getContext(),ForTwitter.class);
                            v.getContext().startActivity(intent6);

                            break;
                        case 7:
                            Intent intent7=new Intent(v.getContext(),Foryoutube.class);
